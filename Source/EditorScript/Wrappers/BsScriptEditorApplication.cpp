...
namespace bs
{
	...
	{
		Path releaseAssemblyFolder = EditorScriptLibrary::getReleaseAssemblyPath();
	...
	{
		Path debugAssemblyFolder = EditorScriptLibrary::getDebugAssemblyPath();
	...
	{
		Path assemblyFolder = EditorScriptLibrary::instance().getScriptAssemblyFolder();
