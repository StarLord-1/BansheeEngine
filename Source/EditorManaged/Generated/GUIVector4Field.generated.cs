...
namespace bs.Editor
{
	...
	/// </summary>
	[ShowInInspector]
	public partial class GUIVector4Field : GUIElement
	{
		private GUIVector4Field(bool __dummy0) { }
		protected GUIVector4Field() { }
		...
		/// </param>
		public GUIVector4Field(GUIContent labelContent, int labelWidth, string style = "")
		{
		...
		/// If not specified default style is used.
		/// </param>
		public GUIVector4Field(GUIContent labelContent, string style = "")
		{
		...
		/// If not specified default style is used.
		/// </param>
		public GUIVector4Field(LocString labelText, int labelWidth, string style = "")
		{
		...
		/// If not specified default style is used.
		/// </param>
		public GUIVector4Field(LocString labelText, string style = "")
		{
		...
		/// If not specified default style is used.
		/// </param>
		public GUIVector4Field(string style = "")
		{
		...
		private static extern void Internal_getValue(IntPtr thisPtr, out Vector4 __output);
		[MethodImpl(MethodImplOptions.InternalCall)]
		private static extern void Internal_setValue(IntPtr thisPtr, ref Vector4 value);
		[MethodImpl(MethodImplOptions.InternalCall)]
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		private static extern void Internal_create(GUIVector4Field managedInstance, ref GUIContent labelContent, int labelWidth, string style);
		[MethodImpl(MethodImplOptions.InternalCall)]
